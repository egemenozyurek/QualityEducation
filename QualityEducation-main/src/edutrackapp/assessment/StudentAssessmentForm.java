...
import edutrackapp.progress.LeaderboardDataAccess;
...
public class StudentAssessmentForm extends JFrame {
    ...
    private void finishQuiz() {
        ...
        // Updating the leaderboard points in database
        try {
            LeaderboardDataAccess lb = new LeaderboardDataAccess();
            lb.addPointsForUsername(studentName, marks);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,
                "Could not update leaderboard: " + ex.getMessage(),
